...
// Modifications copyright (C) 2017 Masato Sogame <poketo7878@gmail.com>
//
...
THREE.DRACOLoader.prototype = {
    ...
    convertDracoGeometryTo3JS: function(wrapper, geometryType, buffer) {
        ...
        if (geometryType == DracoModule.TRIANGULAR_MESH) {
          //geometry.setIndex(
              //new(geometryBuffer.indices.length > 65535 ? THREE.Uint32BufferAttribute : THREE.Uint16BufferAttribute)(geometryBuffer.indices, 1));
        }
